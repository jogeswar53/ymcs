												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															...
															<form:input type="text" disabled="true" id="totalAmount" path="totalAmount" class="form-control" />
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<form:input type="text" disabled="true" id="pendingAmount" path="pendingAmount" class="form-control" />
														</div>
													</div>
												</div>
											</fieldset>
											<div class="row ">
												<div class="col-md-8 text-center pull-right">
													<a class="btn navbar-btn btn-default" 
														href="${contextPath}/admin/viewOrders?pid=12&mid=13">Cancel</a> &nbsp;&nbsp;
													<a class="btn navbar-btn btn-primary" 
														onclick="$(this).closest('form').submit();">Paid</a>
												</div>
											</div>
										</form:form>
									</c:if>
