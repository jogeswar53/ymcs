											...
											<table id="Order_table" class="portal-table table table-bordered table-hover" width="98%">
												...
												<tbody>
													<c:forEach items="${ orders }" var="order" varStatus="i">
														<tr data-id="${ i.count }" >
															<td>
																<a href="${contextPath}/admin/updateOrder?orderId=
																${ order.orderId }&pid=12&mid=13">${ order.orderId }</a>
															</td>
															<td>${ order.orderNo }</td>
															...
															<td>
																...
																<span class="deleteOrder" data-target="#deleteOrderModel">
																	<a href="${contextPath}/admin/printOrder?orderId=
																		${ order.orderId }&pid=12&mid=13">
